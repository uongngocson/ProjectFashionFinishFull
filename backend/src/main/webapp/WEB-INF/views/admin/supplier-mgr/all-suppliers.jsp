<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <c:set var="ctx" value="${pageContext.request.contextPath}" /> <%-- Added context path --%>
                                                                ...
                                                                <tbody>
                                                                    <c:forEach var="supplier" items="${suppliers}"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="btn-group">
                                                                                    <a href="${ctx}/admin/supplier-mgr/detail/${supplier.supplierId}"
                                                                                        class="btn btn-sm btn-info">
                                                                                        <i class="fas fa-eye"></i>
                                                                                    </a>
                                                                                    <a href="${ctx}/admin/supplier-mgr/update/${supplier.supplierId}"
                                                                                    ...
                                                                                    <%-- Form for delete action --%>
                                                                                        <form
                                                                                            ...
                                                                                            action="${ctx}/admin/supplier-mgr/delete/${supplier.supplierId}"
                                                                                            method="POST"
                                                                                            ...
                                                                                            <%-- Add CSRF token --%>
                                                                                                ...
                                                                                                <button type="button"
                                                                                                    ...
                                                                                                    onclick="confirmDeleteSupplier('${supplier.supplierId}', '${supplier.supplierName}')">
                                                                                                    <i
                ...
                <script>
                    function confirmDeleteSupplier(supplierId, supplierName) {
                        swal({
                            ...
                            text: "Bạn có thực sự muốn xóa nhà cung cấp '" + supplierName + "'? Hành động này không thể hoàn tác.",
                            icon: "warning",
                            buttons: {
                                cancel: {
                                    text: "Hủy",
