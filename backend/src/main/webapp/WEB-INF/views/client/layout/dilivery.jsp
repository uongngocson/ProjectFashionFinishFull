                    ...
                    <div class="container mx-auto p-4">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:w-1/2">
                            ...
                            <div class="bg-white p-6 rounded-lg shadow-md">
                                <h2 class="text-xl font-semibold mb-4 text-black">Thông tin khách hàng</h2>
                                <div class="space-y-4">
                                    <div>
                                        <label for="fullName" class="block text-sm font-medium text-black mb-1">Họ và
                                            tên</label>
                                    ...
                                    <div>
                                        <label for="customerId" class="block text-sm font-medium text-black mb-1">Mã
                                            khách hàng</label>
                                        <input type="text" id="customerId"
                                            class="w-full p-2 border rounded-md text-black bg-white" readonly>
                                    </div>
                                    <div>
                                        <label for="email"
                                            class="block text-sm font-medium text-black mb-1">Email</label>
                                        <input type="email" id="email"
                                            class="w-full p-2 border rounded-md text-black bg-white"
                                            placeholder="example@email.com">
                                    </div>
                                    <div>
                                        <label for="phone" class="block text-sm font-medium text-black mb-1">Số điện
                                            thoại</label>
