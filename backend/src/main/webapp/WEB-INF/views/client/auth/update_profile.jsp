...
<head>
    ...
    <style>
        ...
        .avatar-container { display: flex; justify-content: center; margin-bottom: 2rem; }
        .avatar { width: 128px; height: 128px; border-radius: 50%; object-fit: cover; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); border: 2px solid #e5e7eb; }
    </style>
</head>
            ...
            <div class="bg-white p-8 shadow-sm rounded-lg">
                <form:form modelAttribute="customer" action="${ctx}/management/profile/update" method="POST"
                    ...
                    <div class="mb-4">
                        ...
                        <form:input path="firstName" class="w-full px-4 py-2 border rounded-full" required="true" />
                    ...
                    <div class="mb-4">
                        ...
                        <form:input path="lastName" class="w-full px-4 py-2 border rounded-full" required="true" />
                    ...
                    <div class="mb-4">
                        ...
                        <form:input path="email" type="email" class="w-full px-4 py-2 border rounded-full" required="true" />
                    ...
                    <div class="mb-4">
                        ...
                        <form:input path="phone" class="w-full px-4 py-2 border rounded-full" required="true" pattern="\d{10}"
                    ...
                    <div class="mb-4">
                        ...
                        <form:input path="dateOfBirth" type="date" value="${formattedDate}" class="w-full px-4 py-2 border rounded-full" required="true" />
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" name="image" class="w-full px-4 py-2 border rounded-full" accept="image/*" />
                    </div>

                    <div class="flex justify-end space-x-4">
                        <a href="${ctx}/management/profile" class="px-6 py-2 border rounded-full">Hủy</a>
                        <button type="submit" class="btn-black bg-black text-white px-6 py-2 rounded-full">Lưu Thay Đổi</button>
                    </div>
                </form:form>
            </div>
        </section>
