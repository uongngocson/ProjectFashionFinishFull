<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            ...
            <title>Đã xảy ra lỗi | FullStackWeb2025News</title>
        ...
        <body>
            <div class="container">
                <div class="error-container">
                    ...
                    <img src="https://i.imgur.com/qIufhof.png" alt="Error Illustration" class="error-illustration">
                    <div class="mb-4">
                        <p>Bạn có thể:</p>
                        <ul class="list-unstyled">
                            <li class="cursor-pointer"><i class="fas fa-arrow-left me-2"></i> Quay lại trang trước đó
                            </li>
                            <li><i class="fas fa-home me-2"></i> Trở về trang chủ</li>
                            <li><i class="fas fa-sync me-2"></i> Tải lại trang</li>
                        </ul>
                    </div>
                    <div class="d-flex justify-content-center gap-3">
                        ...
                        <button onclick="window.location.reload()" class="btn btn-outline-secondary">
                            <i class="fas fa-sync me-2"></i> Tải lại trang
                        </button>
                    </div>
                </div>
            </div>
