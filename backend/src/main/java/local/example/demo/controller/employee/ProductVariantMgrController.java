...
@Controller("employeeProductVariantMgrController")
@RequestMapping("/employee/product-variant-mgr")
...
public class ProductVariantMgrController {
    ...
    public String showAddVariantForm(@PathVariable("productId") Integer productId, Model model) {
        ...
        model.addAttribute("formAction", "/employee/product-variant-mgr/add");
        return "employee/product-mgr/form-variant"; // You'll need to create this JSP
    }
    ...
    public String addVariant(@Valid @ModelAttribute("productVariant") ProductVariant productVariant,
        ...
        if (result.hasErrors()) {
            ...
            model.addAttribute("formAction", "/employee/product-variant-mgr/add");
            return "employee/product-mgr/form-variant";
        }
        ...
        return "redirect:/employee/product-mgr/detail/" + productVariant.getProduct().getProductId();
    }
    ...
    public String showEditVariantForm(@PathVariable("variantId") Integer variantId, Model model) {
        ...
        if (variant == null) {
            ...
            return "redirect:/employee/product-mgr/list"; // Or back to product detail
        }
        model.addAttribute("productVariant", variant);
        model.addAttribute("product", variant.getProduct());
        model.addAttribute("colors", colorService.getAllColors());
        model.addAttribute("sizes", sizeService.getAllSizes());
        model.addAttribute("formAction", "/employee/product-variant-mgr/edit");
        return "employee/product-mgr/form-variant"; // Reuse the same form JSP
    }
    ...
    public String deleteVariant(@PathVariable("variantId") Integer variantId, RedirectAttributes redirectAttributes) {
        ...
        if (variant == null) {
            ...
            return "redirect:/employee/product-mgr/list"; // Or a more appropriate page
        }
